export const metricInsightMap = {
  school: {
    school_employment_samples: {
      ...
      scope: '当前学校纳入统计的就业样本',
      interpretation: '数值越大，当前学校可用于就业分析的样本越充分；如果样本偏少，结论更适合结合专业明细进一步查看。',
    ...
    school_lead_industry_employment: {
      ...
      interpretation: '数值越高，通常代表学校与重点产业方向的衔接更紧密，但仍需结合专业结构和总样本一起看。',
      updatedAt: '由 Dashboard 传入的数据更新时间补充',
    ...
    school_major_coverage: {
      ...
      interpretation: '覆盖专业越多，学校层面的分析视角越完整；如果覆盖较少，部分专业可能暂未纳入充分观察。',
      updatedAt: '由 Dashboard 传入的数据更新时间补充',
  ...
  gov: {
    gov_school_coverage: {
      ...
      scope: '当前全市高校监测范围',
      interpretation: '数值越高，平台对全市高校的覆盖越充分；如果覆盖不足，横向比较的完整性会受到影响。',
      updatedAt: '由 Dashboard 传入的数据更新时间补充',
    ...
    gov_lead_industry_employment: {
      ...
      scope: '全市高校重点产业去向样本',
      interpretation: '数值越高，通常代表重点产业对高校毕业生吸纳能力较强，但仍需结合产业结构和高校差异理解。',
      updatedAt: '由 Dashboard 传入的数据更新时间补充',
