...
import { designTokens, panelStyle, primaryButtonStyle } from '../utils/uiTheme'
import './publicPortal.css'

export default function PublicHeroBanner({ onAction }) {
  ...
  return (
    <Card bodyStyle={{ padding: 0 }} style={cardStyle} className="public-hero-banner public-section-fade">
      <Button
        type="text"
        aria-label="上一张"
        icon={<LeftOutlined />}
      ...
      <Carousel ref={carouselRef} autoplay effect="fade" autoplaySpeed={5200} dots>
